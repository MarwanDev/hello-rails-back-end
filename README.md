...
A rails app that has different greetings stored in a rails backend API and connected to the frontend react project <a href="https://github.com/MarwanDev/hello-react-front-end">here</a>
...
```sh
cd my-folder
git clone https://github.com/MarwanDev/hello-rails-back-end.git
